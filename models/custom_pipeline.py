...
class Generator4Embeds:
    ...
    def __init__(self, num_inference_steps=1, device='cuda') -> None:
        ...
        path = '/home/yin_1/.cache/huggingface/hub/models--stabilityai--sdxl-turbo/snapshots/71153311d3dbb46851df1931d3ca6e939de83304'
        ...
        pipe = DiffusionPipeline.from_pretrained(path, torch_dtype=torch.float32, variant="fp16")
        pipe.to(device)
...
if __name__ == "__main__":
    path = '/home/yin_1/.cache/huggingface/hub/models--stabilityai--sdxl-turbo/snapshots/f4b0486b498f84668e828044de1d0c8ba486e05b'

    pipe = DiffusionPipeline.from_pretrained("stabilityai/sdxl-turbo", torch_dtype=torch.float32, variant="fp16")
    # pipe = DiffusionPipeline.from_pretrained(path, torch_dtype=torch.float32, variant="fp16")
    # pipe.to("cuda:0")
    ...
    # encode image
    # image_embeds = encode_image(image_prompt, image_encoder, feature_extractor, 1, "cuda")
    image_embeds = image_encoder.encode_image(feature_extractor(image_prompt)[None, ...].to("cuda", dtype=torch.float32))
